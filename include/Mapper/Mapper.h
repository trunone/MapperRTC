  ...
  : public RTC::DataFlowComponentBase
{
 ...
 protected:
  ...
  RTC::TimedPose2D m_EstPose;
  /*!
   */
  OutPort<RTC::TimedPose2D> m_EstPoseOut;
...
extern "C"
{
  DLL_EXPORT void MapperInit(RTC::Manager* manager);
};
